<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-title v-if="value._links">
            SalesOrder # {{decode(value._links.self.href.split("/")[value._links.self.href.split("/").length - 1])}}
        </v-card-title >
        <v-card-title v-else>
            SalesOrder
        </v-card-title >        
        ...
        <v-card-text>
            ...
            <SalesProductManager offline label="SalesProducts" v-model="value.salesProducts" :editMode="editMode" @change="change"/>
        </v-card-text>
