    ...
    <v-col :cols="10">
        ...
        <div style="max-height:80vh; margin-top: 90px;">
            <div class="panel">
                    ...
                    <v-table>
                        ...
                        <tbody>
                            <tr v-for="(val, idx) in value" :key="val" @click="changeSelectedRow(val)" :style="val === selectedRow ? 'background-color: #f0f3ff;':''">
                                ...
                                <td class="whitespace-nowrap" label="Company">
                ...
                <SalesProductDetailGrid style="margin-top: 20px;" label="SalesProducts" offline v-if="selectedRow" v-model="selectedRow.salesProducts" :selectedRow="selectedRow"/>
            </div>
            <v-col>
                <v-dialog
                    v-model="openDialog"
...
import SalesProductDetailGrid from './SalesProductDetailGrid.vue'
